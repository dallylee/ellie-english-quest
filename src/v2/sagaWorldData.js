...
const cloudHarborTasks = [
  {
    id: "wake-the-dock",
    title: "Wake the Dock",
    storyPurpose: "Luma needs ELI's voice to start the harbor magic.",
    visualFocus: "Luma glow and dim dock",
    screenObject: "Luma glow beside the sleepy dock",
    objectKey: "luma-memory",
    answerType: "greeting",
    lumaLine: "First, let the harbor hear your voice. Can you say hello to me?",
    spokenLine: "First, let the harbor hear your voice. Can you say hello to me?",
    suggestedDisplayLine: `Hello Luma, I am ${displayLearnerName}.`,
    suggestedSpokenLine: `Hello Luma, I am ${spokenLearnerName}.`,
    expectedAnswer: `Hello Luma, I am ${displayLearnerName}.`,
    expectedSpokenAnswer: `Hello Luma, I am ${spokenLearnerName}.`,
    targetWords: ["hello", "luma", "eli", "ellie"],
    successAnimation: "The dock sparkles awake and the first progress gem lights.",
    successLine: "I heard you, ELI. The dock is waking up.",
    successSpokenLine: "I heard you, Ellie. The dock is waking up.",
    gentleHint: "I heard a little sound. Try hello Luma.",
  ...
  },
  {
    ...
    storyPurpose: "The lantern wakes and shows the first clue path.",
    visualFocus: "Sleepy lantern on the left side of the dock",
    screenObject: "A sleepy lantern on the dock",
    objectKey: "lantern",
    answerType: "guided-phrase",
    lumaLine: "Look, the lantern is asleep. It only wakes up for kind words. What should we ask?",
    spokenLine: "Look, the lantern is asleep. It only wakes up for kind words. What should we ask?",
    ...
    bonusWords: ["please"],
    successAnimation: "The lantern glows warm gold and reveals tiny blue cloud marks.",
    successLine: "Yes. The lantern is awake. It is showing us tiny cloud marks.",
    successSpokenLine: "Yes. The lantern is awake. It is showing us tiny cloud marks.",
    gentleHint: "The lantern needs two words: light and lantern.",
  ...
  },
  {
    ...
    visualFocus: "Folded flag and three wind ribbons",
    screenObject: "Folded flag with blue, red and yellow wind ribbons",
    objectKey: "flag",
    answerType: "choice",
    lumaLine: "The flag is folded. I see three little winds: blue, red and yellow. The lantern showed a blue mark. Which wind should we use?",
    spokenLine: "The flag is folded. I see three little winds: blue, red and yellow. The lantern showed a blue mark. Which wind should we use?",
    expectedAnswer: "Blue wind.",
    targetWords: ["blue"],
    successAnimation: "The blue ribbon flies into the flag and the flag rises.",
    successLine: "Blue wind. Good thinking. Let's remember blue.",
    successSpokenLine: "Blue wind. Good thinking. Let's remember blue.",
    gentleHint: "Look at the lantern mark. It is blue. Which colour?",
    supportInteraction: "",
    mood: "thinking",
  ...
  },
  {
    ...
    storyPurpose: "ELI notices the sparkle and names the hidden key.",
    visualFocus: "Three cloud puffs with a silver sparkle",
    screenObject: "Three cloud puffs float above the dock, one hides a key.",
    objectKey: "silver-key",
    answerType: "observation",
    lumaLine: "Something is hiding in the clouds. I see a tiny sparkle. What can you see?",
    spokenLine: "Something is hiding in the clouds. I see a tiny sparkle. What can you see?",
    suggestedDisplayLine: "I can see the silver key.",
    suggestedSpokenLine: "I can see the silver key.",
    expectedAnswer: "I can see the silver key.",
    targetWords: ["silver", "key"],
    bonusWords: ["see"],
    successAnimation: "The cloud puffs pop gently and the silver key floats to Luma's side.",
    successLine: "A silver key. Perfect. I think this key belongs to the little gate.",
    successSpokenLine: "A silver key. Perfect. I think this key belongs to the little gate.",
    gentleHint: "Try silver key.",
  ...
  },
  {
    ...
    storyPurpose: "ELI remembers the blue wind clue and adds blue rain to the potion.",
    ...
    objectKey: "potion",
    answerType: "memory",
    lumaLine: "The bridge wind is too weak. Remember the flag? It was blue. Can you say: Add blue rain, please?",
    spokenLine: "The bridge wind is too weak. Remember the flag? It was blue. Can you say: Add blue rain, please?",
    expectedAnswer: "Add blue rain, please.",
    targetWords: ["add", "blue", "rain"],
    bonusWords: ["please"],
    successAnimation: "The potion turns bright blue and bubbles into a wind spiral.",
    successLine: "The blue breeze potion is ready.",
    successSpokenLine: "The blue breeze potion is ready.",
    gentleHint: "We need blue rain. Say blue rain.",
  ...
  },
  {
    ...
    storyPurpose: "ELI combines the silver key with a kind request to open the gate.",
    visualFocus: "Cloud gate on the right with the silver key nearby",
    screenObject: "A small cloud gate blocks the dock path.",
    objectKey: "gate",
    answerType: "guided-phrase",
    lumaLine: "Here is the little gate. We have the silver key. Let's ask it kindly. Say: Open the gate, please.",
    spokenLine: "Here is the little gate. We have the silver key. Let's ask it kindly. Say: Open the gate, please.",
    expectedAnswer: "Open the gate, please.",
    targetWords: ["open", "gate"],
    bonusWords: ["please", "key", "silver"],
    successAnimation: "The key turns and the gate opens with a soft cloud swirl.",
    successLine: "The gate opened. The bridge pieces are listening now.",
    successSpokenLine: "The gate opened. The bridge pieces are listening now.",
    gentleHint: "Use open and gate.",
    supportInteraction: "",
    mood: "happy",
    rewardEvent: "gate-open"
  },
  {
    id: "cast-cloud-path-spell",
    title: "Cast the Cloud Path Spell",
    storyPurpose: "ELI uses a magic phrase to show the bridge pieces where to go.",
    visualFocus: "Spell circle and faint bridge outline",
    screenObject: "A glowing spell circle appears on the dock floor.",
    objectKey: "spell-circle",
    answerType: "magic-spell",
    lumaLine: "The bridge pieces are awake, but they do not know where to go. Say: Clouds, show the way.",
    spokenLine: "The bridge pieces are awake, but they do not know where to go. Say: Clouds, show the way.",
    expectedAnswer: "Clouds, show the way.",
    targetWords: ["clouds", "show", "way"],
    successAnimation: "The spell circle spins and a glowing path appears between bridge pieces.",
    successLine: "The path is showing. One more brave voice, ELI.",
    successSpokenLine: "The path is showing. One more brave voice, Ellie.",
    gentleHint: "Try clouds, show the way.",
    supportInteraction: "",
    mood: "surprised",
  ...
  },
  {
    ...
    storyPurpose: "ELI resolves the level and opens the route to Breakfast Breeze.",
    ...
    lumaLine: "The lantern is bright. The flag found blue wind. The key opened the gate. The potion woke the breeze. Can you say: I am ready for the next island?",
    spokenLine: "The lantern is bright. The flag found blue wind. The key opened the gate. The potion woke the breeze. Can you say: I am ready for the next island?",
    expectedAnswer: "I am ready for the next island.",
    targetWords: ["ready", "next", "island"],
    successAnimation: "Bridge pieces assemble, the Cloud Compass appears and all progress gems glow.",
    successLine: "You did it, ELI. Cloud Harbor is awake. We found the Cloud Compass.",
    successSpokenLine: "You did it, Ellie. Cloud Harbor is awake. We found the Cloud Compass.",
...
const skyLevels = [
  {
    ...
    storyIntro: {
      displayText: "Hello, ELI. I am Luma. This is Cloud Harbor. It should be bright and windy, but the sky storm made it sleepy. Can you help me wake it up?",
      spokenText: "Hello, Ellie. I am Luma. This is Cloud Harbor. It should be bright and windy, but the sky storm made it sleepy. Can you help me wake it up?",
      followUpDisplayText: "We need the lantern, the flag, the silver key and a tiny breeze potion. Then we can open the first bridge.",
      followUpSpokenText: "We need the lantern, the flag, the silver key and a tiny breeze potion. Then we can open the first bridge."
    },
    storyMemory: {
